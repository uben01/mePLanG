...
/*package*/ class Program_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createConstant_0() {
    ...
    style.set(StyleAttributes.MATCHING_LABEL, "program");
  ...
  private EditorCell createRefNodeList_0() {
    AbstractCellListHandler handler = new bodyListHandler_c7xntw_c0(myNode, getEditorContext());
  ...
  private static class bodyListHandler_c7xntw_c0 extends RefNodeListHandler {
    @NotNull
    private SNode myNode;

    public bodyListHandler_c7xntw_c0(SNode ownerNode, EditorContext context) {
      super(context, false);
      myNode = ownerNode;
    }
    ...
    public EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(bodyListHandler_c7xntw_c0.this.getNode(), LINKS.body$f8ql));
      try {
  ...
  private EditorCell createEmpty_0() {
    ...
    editorCell.setCellId("Empty_c7xntw_d0");
    return editorCell;
  }
  private EditorCell createConstant_1() {
    EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, "PROGRAM_VÉGE");
